...
public class CreateSignature {
	...
	HashMap<String, List> cmap = new HashMap<>();
	...
	List<Pair> aliases2 = new ArrayList<>();
	List<String> sequence = new ArrayList<>();

	ExtendedMap xmap = ScanRules(body, aliases, p, sequence); // Scan the rules & Generate the hashmap
	map = xmap.map;
	...
	while (!cmap.isEmpty()) {
	    ...
	    sig = "";
	    DFSJoin(root, cmap, body, false, false, bph, aliases);
	...
	HashMap<String, List> varMap = new HashMap<>();
	int atomCounter = 0;
