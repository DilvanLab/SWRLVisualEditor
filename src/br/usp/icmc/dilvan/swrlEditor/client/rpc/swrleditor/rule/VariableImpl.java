...
public class VariableImpl implements Variable {
	...
	} else if(variableID.trim().startsWith("?"))
	...
	simpleLabel = "";
	comment = "";
	typeVariable = TYPE_VARIABLE.NULL;
    }
	...
	return simpleID.equals( ((Variable)variable).getSimpleID()) || simpleLabel.equals( ((Variable)variable).getSimpleID());
    }
